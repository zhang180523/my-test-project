<template>
  <div class="vipcard">
    ...
    <div id="div1">
      <p id="p1">为账户<span>zfbwasd123</span>购买会员</p>
      <section id="section1">
        <a href="">
          <span>会员特权</span>
          <section>
      ...
      <section id="section2">
        <header><span>开通会员</span></header>
        <section>
          <div><span>1个月</span><span>￥20</span></div>
          <div><p>购买</p></div>
        </section>
      </section>
      <div class="div2">
        <span>兑换会员</span>
        <section>
          <span>使用卡号卡密</span><i class="iconfont icon-youjiantou"></i>
        </section>
      </div>
      <div class="div2">
        <span>购买记录</span>
        <section>
          <span>开发票</span><i class="iconfont icon-youjiantou"></i>
        </section>
      </div>
    </div>
  </div>
